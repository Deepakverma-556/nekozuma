...
const Story = () => {
  return (
    <div id='story' className='dark-gray pt-5'>
      <Heading text={"Story"} />
      ...
      <Description myClass={'text-center px-3 max-w-lg mx-auto text-custom-xs pb-4 pb-md-5 mt-md-2'} text={"However at every junction in time, there is always a darkness that is waiting to overthrow the good. Hence, each timeline has its own arch nemesis. This means that there will be a total of 4 godly nekos from each timeline making a total of 12 godly nekos that will be fully animated."} />
      <Image width={1280} height={357} src={"/assets/images/webp/story.webp"} alt='story' className='w-100 object-fit-cover h-base'/>
    </div>
  )
}
