        ...
        <div className='dark-gray'>
            <div className='max-w-extra-large mx-auto position-relative'>
                ...
                <div className='container px-4 max-w-extra pt-xxxl pb-xxxl mx-auto'>
                    ...
                    <Description myClass={'max-w-large pt-lg-xs pb-lg-xxl pt-0 pb-4'} text={"The collection  of 5555 NFTs on the Solana blockchain. The collection serves to be a rising force against the anime meta of collections with undoxxed teams and is therefore backed by the team at Nubbies NFT & Karmic Labs."} />
                ...
                <Image src={'/assets/images/png/lightning.png'} alt='lightning' width={211} height={280} className='position-absolute bottom-0 size-lg start-0 pe-none size-lg-xxl d-custom-none'/>
          </div>
        </div>
    )
}
