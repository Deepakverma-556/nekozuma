          ...
          {TEAM_LIST.map((obj, i) => (
            <div key={i} className='col-md-3 col-sm-4 px-sm pt-sm-4 pt-2 mt-3'>
              <div>
                ...
                <p className='fs-4 custom-blue text-center franklin pt-2 pt-lg-4 pb-lg-2'>{obj.title}</p>
                ...
                <Link href={obj.link} className='mx-auto max-w-max d-flex icon pt-2'><Twitter myClass={'size-sm'} /></Link>
              </div>
            </div>
          ))}
        </div>
